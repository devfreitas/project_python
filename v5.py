...
def formatar_registro(r) -> str:
    ...
    nome, autor, genero, preco, paginas, descricao, data_pub = r
...
def gerar_arquivo_exportacao(dados, tipo_arquivo, nome_arquivo):
    try:
        ...
        for registro in dados:
            nome, autor, genero, preco, paginas, descricao, data_pub = registro
...
def editar_livro() -> None:
    ...
    nova_descricao = input("Nova descrição (enter para manter): ") or r[5]
